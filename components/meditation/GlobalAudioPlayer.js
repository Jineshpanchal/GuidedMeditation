...
const GlobalAudioPlayer = () => {
  ...
  return (
    <div className={`fixed bottom-0 left-0 right-0 bg-gradient-to-r from-pink-50 via-spiritual-light/10 to-blue-50 shadow-lg z-50 transition-all duration-300 backdrop-blur-sm ${
      isMinimized ? 'h-12' : 'p-3'
    }`}>
        ...
        {isMinimized ? (
          ...
          <>
            ...
            <div className="relative w-full h-4 flex items-center">
              ...
              {/* Invisible range input for better interaction */}
              <input
                type="range"
                min="0"
                max="100"
