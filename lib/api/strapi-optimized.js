...
export const getAgeGroups = async (preset = 'minimal', customParams = {}) => {
  ...
  const cacheKey = generateCacheKey('age-groups', params);
...
export const getMeditations = async (preset = 'card', customParams = {}) => {
  ...
  const cacheKey = generateCacheKey('meditations', params);
...
export const getTeachers = async (preset = 'card', customParams = {}) => {
  ...
  const cacheKey = generateCacheKey('teachers', params);
...
export const getCategoriesByAgeGroup = async (ageGroupSlug) => {
  const cacheKey = generateCacheKey('categories-by-age-group', { ageGroupSlug });
...
export const getTrendingMeditationsByAgeGroup = async (ageGroupSlug) => {
  const cacheKey = generateCacheKey('trending-meditations-by-age-group', { ageGroupSlug });
...
export const getMeditationCountsByCategories = async (categoryIds) => {
  const cacheKey = generateCacheKey('meditation-counts-by-categories', { categoryIds: categoryIds.sort() });
...
export const getMeditationBySlug = async (slug) => {
  const cacheKey = generateCacheKey('meditation-by-slug', { slug });
...
export const getTeacherBySlug = async (slug) => {
  const cacheKey = generateCacheKey('teacher-by-slug', { slug });
...
export const getAgeGroupPageData = async (ageGroupSlug) => {
  const cacheKey = generateCacheKey('age-group-page-data', { ageGroupSlug });
...
export const getTeachersPageData = async () => {
  const cacheKey = generateCacheKey('teachers-page-data', {});
...
export const getTeacherPageData = async (teacherSlug) => {
  const cacheKey = generateCacheKey('teacher-page-data', { teacherSlug });
...
export const getExplorePageData = async () => {
  const cacheKey = generateCacheKey('explore-page-data', {});
...
export const getMeditationPageData = async (slug) => {
  const cacheKey = generateCacheKey('meditation-page-data', { slug });
